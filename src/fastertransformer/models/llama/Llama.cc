...
{
    llama_context_decoder_ = new LlamaContextDecoder<T>(0,
                                                     0,
                                                     head_num_,
                                                     size_per_head_,
                                                     inter_size_,
    ...
    llama_decoder_ = new LlamaDecoder<T>(0,
                                      head_num_,
                                      size_per_head_,
                                      inter_size_,
                                      num_layer_,
...
template<typename T>
Llama<T>::Llama(size_t                              max_batch_size,
              size_t                              max_seq_len,
                      ...
                      const LlamaWeight<T>*                           llama_weights)
{
    ...
    if (vocab_size_ == vocab_size_padded_) {
        ...
        padded_embedding_bias_ptr_   = llama_weights->post_decoder_embedding.bias;
    }
    else {
