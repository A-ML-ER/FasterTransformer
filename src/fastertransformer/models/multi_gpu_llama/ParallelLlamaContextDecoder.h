...
template<typename T>
class ParallelLlamaContextDecoder: public BaseLayer {
private:
    // buffer handling
...
protected:
public:
    ParallelLlamaContextDecoder(size_t                              max_batch_size,
                              size_t                              max_seq_len,
                              size_t                              head_num,
    ...
    ParallelLlamaContextDecoder(ParallelLlamaContextDecoder<T> const& decoder);

    ~ParallelLlamaContextDecoder();
