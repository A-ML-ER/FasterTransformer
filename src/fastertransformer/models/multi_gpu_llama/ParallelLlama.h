...
template<typename T>
class ParallelLlama: public BaseLayer {
private:
    // meta data
    size_t               head_num_;
    ...
    ParallelLlamaDecoder<T>*        llama_decoder_;
    ParallelLlamaContextDecoder<T>* llama_context_decoder_;
...
public:
    ParallelLlama(size_t                              max_batch_size,
                size_t                              max_seq_len,
                size_t                              max_input_len,
                size_t                              beam_width,
                size_t                              head_num,
    ...
    ParallelLlama(ParallelLlama<T> const& llama);
