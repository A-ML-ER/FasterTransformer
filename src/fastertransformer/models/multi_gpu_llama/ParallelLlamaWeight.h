...
template<typename T>
struct ParallelLlamaWeight {

    ParallelLlamaWeight() = default;
    ParallelLlamaWeight(const int                                  hidden_units,
    ...
    ~ParallelLlamaWeight();
    ParallelLlamaWeight(const ParallelLlamaWeight& other);
    ParallelLlamaWeight& operator=(const ParallelLlamaWeight& other);
    ...
    std::vector<ParallelLlamaDecoderLayerWeight<T>*> decoder_layer_weights;
