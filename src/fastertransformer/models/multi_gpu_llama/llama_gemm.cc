...
int main(int argc, char* argv[])
{
    ...
    void*  gemm_test_buf;
    size_t buf_size_in_byte = ft::calLlamaGemmTestBufSizeInByte(batch_size,
                                                              beam_width,
                                                              max_input_len,
                                                              head_num,
                                                              size_per_head,
    ...
    if (data_type == ft::FLOAT_DATATYPE) {
        ft::generate_llama_gemm_config<float>(batch_size,
                                            beam_width,
                                            max_input_len,
                                            head_num,
                                            size_per_head,
        ...
        ft::generate_llama_gemm_config<half>(batch_size,
                                           beam_width,
                                           max_input_len,
                                           head_num,
                                           size_per_head,
        ...
        ft::generate_llama_gemm_config<__nv_bfloat16>(batch_size,
                                                    beam_width,
                                                    max_input_len,
                                                    head_num,
                                                    size_per_head,
        ...
        ft::generate_llama_gemm_config<__nv_fp8_e4m3>(batch_size,
                                                    beam_width,
                                                    max_input_len,
                                                    head_num,
                                                    size_per_head,
