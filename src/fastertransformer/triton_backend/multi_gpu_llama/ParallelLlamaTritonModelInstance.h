...
template<typename T>
struct ParallelLlamaTritonModelInstance: AbstractTransformerModelInstance {

    ParallelLlamaTritonModelInstance(std::unique_ptr<ft::ParallelLlama<T>>                     llama,
    ...
    ~ParallelLlamaTritonModelInstance();
...
private:
    const std::unique_ptr<ft::ParallelLlama<T>>                     llama_;
    const std::shared_ptr<ft::ParallelLlamaWeight<T>>               llama_weight_;
