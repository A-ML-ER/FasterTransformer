...
template<typename T>
struct ParallelLlamaTritonModel: public AbstractTransformerModel {
    ParallelLlamaTritonModel(size_t                                     max_seq_len,
                           size_t                                     head_num,
    ...
    ParallelLlamaTritonModel(size_t      tensor_para_size,
                           size_t      pipeline_para_size,
                           int         enable_custom_all_reduce,
                           std::string model_dir,
                           int         int8_mode);
...
private:
    ...
    std::vector<std::shared_ptr<ft::ParallelLlamaWeight<T>>> shared_weights_;

    // model variants parameters
    ft::llamaVariantParams llama_variant_params_ = {};
