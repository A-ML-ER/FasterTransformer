...
#include "src/fastertransformer/utils/gemm_test/llama_gemm_func.h"
...
template<typename T>
void generate_llama_gemm_config(int   batch_size,
                              int   beam_width,
                              int   max_input_len,
                              int   head_num,
                              int   size_per_head,
                              ...
                              bool  isAppend)
{
    ...
    printf("***Llama Gemm Testing End***\n");
    return;
}

template void generate_llama_gemm_config<float>(int   batch_size,
                                              int   beam_width,
                                              int   max_input_len,
                                              int   head_num,
                                              int   size_per_head,
...
template void generate_llama_gemm_config<half>(int   batch_size,
                                             int   beam_width,
                                             int   max_input_len,
                                             int   head_num,
                                             int   size_per_head,
...
#ifdef ENABLE_BF16
template void generate_llama_gemm_config<__nv_bfloat16>(int   batch_size,
                                                      int   beam_width,
                                                      int   max_input_len,
                                                      int   head_num,
                                                      int   size_per_head,
...
#ifdef ENABLE_FP8
template void generate_llama_gemm_config<__nv_fp8_e4m3>(int   batch_size,
                                                      int   beam_width,
                                                      int   max_input_len,
                                                      int   head_num,
                                                      int   size_per_head,
...
size_t calLlamaGemmTestBufSizeInByte(int            batch_size,
                                   int            beam_width,
                                   int            max_input_len,
                                   int            head_num,
                                   int            size_per_head,
                                   ...
                                   CublasDataType data_type)
{
    ...
    printf(" calLlamaGemmTestBufSizeInByten sizeof(float) %s . \n", wordSize);
